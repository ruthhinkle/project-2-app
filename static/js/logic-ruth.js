...
d3.json("https://gbfs.divvybikes.com/gbfs/en/station_information.json").then(function (infoRes) {
    ...
    d3.json("https://gbfs.divvybikes.com/gbfs/en/station_status.json").then(function (statusRes) {
        ...
        function populate() {
            ...
            for (var i = 0; i < stationInfo.length; i++) {
                ...
                markers.addTo(layers[stationStatusCode]);

                // Bind a popup to the marker that will  display on being clicked. This will be rendered as HTML.
                markers.bindPopup(station.name + "<br> Capacity: " + station.capacity + "<br>" + station.num_bikes_available + " Bikes Available");
    ...
    function updateLegend(time, stationCount) {
        ...
        // if (station) {
        //   markers.addLayer(L.marker([station.lat, station.lon])).bindPopup(station.name + "<br> Capacity: " + station.capacity + "<br>" + station.num_bikes_available + " Bikes Available")
        // };
